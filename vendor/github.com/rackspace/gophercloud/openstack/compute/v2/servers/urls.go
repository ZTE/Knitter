...
func attachURL(client *gophercloud.ServiceClient, id string) string{
	return client.ServiceURL("servers", id, "os-interface")
}

func detachURL(client *gophercloud.ServiceClient, server_id string, port_id string) string{
	return client.ServiceURL("servers", server_id, "os-interface", port_id)
}
